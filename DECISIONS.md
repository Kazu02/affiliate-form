...
- 注意点として残す: **7/30以降、承認は1件も増えていない**（202605〜202607 のいずれも数値が動いていない）。202607 の承認率22%は 202605(56%)・202606(51%) と比べて明らかに低い。広告主シートは「メインSSに正しく追随できている」状態であって、**メインSS自体の7月分の承認記入が途中である可能性**は残る。承認情報の出所は外部（広告主）なのでAI側では判定できず、提出前にユーザー確認が要る。
